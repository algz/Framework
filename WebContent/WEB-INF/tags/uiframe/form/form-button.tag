...
<%@attribute name="buttonType"  rtexprvalue="true" required="false" description="按钮类型:button(默认),reset,submit" %>
...
<input <%=id==null?"":"id="+id %> class="btn ${buttonClass==null?'':buttonClass }" type="submit" value="${label }">
<%}else if(url!=null){%>
