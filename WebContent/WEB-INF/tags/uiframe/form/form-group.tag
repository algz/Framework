...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input class="${formClass==null?'col-xs-10 col-sm-5':'' }" id="${id }" name="${name==null?id:name }" ${readonly=='true'?'readonly':'' } type="${type==null?'text':type }" placeholder="${defaultText }" <%=value==null?"":"value="+value  %>>
	</div>
</div>