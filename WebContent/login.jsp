...
url=request.getAttribute("org.springframework.web.servlet.HandlerMapping.pathWithinHandlerMapping")+"";
%>
<!DOCTYPE html>
<html lang="zh">
	<head>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">飞机论证参照</span>
									<span class="white" id="id-text2">系统</span>
								</h1>
								<h4 class="blue" id="id-company-text">${companytext }</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form id="loginForm" action="/algz/login" method="post">
												<fieldset>
													...
													<div class="clearfix">
														...
														<button id="subBtn" class="width-35 pull-right btn btn-sm btn-primary" type="button">
