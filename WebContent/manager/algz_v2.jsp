...
<head>
    ...
    <!-- Morris -->
    <link href="<%=basePath %>platform/common/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="<%=basePath %>platform/common/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="<%=basePath %>platform/common/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="<%=basePath %>platform/common/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="<%=basePath %>platform/common/js/plugins/flot/jquery.flot.pie.js"></script>
    ...
    <!-- 自定义js -->
    <script src="<%=basePath %>platform/common/js/content.min.js?v=1.0.0"></script>


    <!-- jQuery UI -->
    <script src="<%=basePath %>platform/common/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- GITTER -->
    <script src="<%=basePath %>platform/common/js/plugins/gritter/jquery.gritter.min.js"></script>

    <!-- EayPIE -->
    <script src="<%=basePath %>platform/common/js/plugins/easypiechart/jquery.easypiechart.js"></script>

    <!-- Sparkline -->
    <script src="<%=basePath %>platform/common/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="<%=basePath %>platform/common/js/demo/sparkline-demo.min.js"></script>
		...
		$(document)
				.ready(
						function() {
							...
							var data1 = [ [ 0, 4 ], [ 1, 8 ], [ 2, 5 ],
									[ 3, 10 ], [ 4, 4 ], [ 5, 16 ], [ 6, 5 ],
									[ 7, 11 ], [ 8, 6 ], [ 9, 11 ], [ 10, 30 ],
									[ 11, 10 ], [ 12, 13 ], [ 13, 4 ],
									[ 14, 3 ], [ 15, 3 ], [ 16, 6 ] ];
							var data2 = [ [ 0, 1 ], [ 1, 0 ], [ 2, 2 ],
									[ 3, 0 ], [ 4, 1 ], [ 5, 3 ], [ 6, 1 ],
									[ 7, 5 ], [ 8, 2 ], [ 9, 3 ], [ 10, 2 ],
									[ 11, 1 ], [ 12, 0 ], [ 13, 2 ], [ 14, 8 ],
									[ 15, 0 ], [ 16, 0 ] ];
