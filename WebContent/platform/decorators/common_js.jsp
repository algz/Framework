...
<!-- algz平台JS -->
<script src="/platform/components/common.js" type="text/javascript"></script>
<script src="/platform/components/accordionMenu.js" type="text/javascript"></script>
<script src="/platform/components/nav.js" type="text/javascript"></script>
<!-- <script src="/ejs.js" type="text/javascript"></script>  --> 
<!-- 缩略图插件 -->
<script src="javascripts/holder.js" type="text/javascript"></script>