 ...
 * Project URL : https://github.com/patternfly/patternfly-bootstrap-treeview
 *
...
;(function ($, window, document, undefined) {
	...
	*/
	Tree.prototype.checkNode = function (nodes, options) {
		...
		$.each(this._orderedNodes, $.proxy(function (index, n){
			$.each(nodes, $.proxy(function (index, node) {
				if(node.nodeId===n.nodeId){
					return this._setChecked(n, true, options);
				}
			},this));
		},this));
	};
	...
	*/
	Tree.prototype.uncheckNode = function (nodes, options) {
		...
		$.each(this._orderedNodes, $.proxy(function (index, n){
			$.each(nodes, $.proxy(function (index, node) {
				if(node.nodeId===n.nodeId){
					return this._setChecked(n, false, options);
				}
			},this));
		},this));
	};
