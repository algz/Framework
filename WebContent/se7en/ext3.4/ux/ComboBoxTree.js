...
Ext.extend(Ext.ux.ComboBoxTree, Ext.form.ComboBox, {
    treePanelWidth : function(iew,ffw)
    {
    ...
    expand : function() {
        ...
        this.treePanelWidth(w,w);
        if(this.ischecked){
	        this.tree.on('checkchange',function(node,checked){ 
	    		var msg = "";
	            var ids = "";
	    		var selNode = this.tree.getChecked();
