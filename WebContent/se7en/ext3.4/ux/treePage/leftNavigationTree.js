...
var leftNavigationTree = {
	...
	nodeId : '0',
	pageSize : 50,
	maxPageSize:10000,//可以配置更大，即使配置更大，页面目前也会死掉。
	rootName : 'Root',
	rootIconCls : 'icon-project',
	activateLocation:function(){
	    //激活定位
	    var loader=leftNavigationTree.treePanel.getLoader();
	    leftNavigationTree.lastParams={};
	    Ext.apply(leftNavigationTree.lastParams,loader.baseParams);
	    loader.pageSize=leftNavigationTree.maxPageSize;
    ...
    deactivateLocation:function(){
    	//取消定位	
	    var loader=leftNavigationTree.treePanel.getLoader();
	    Ext.apply(loader.baseParams,leftNavigationTree.lastParams);
	    loader.pageSize=leftNavigationTree.pageSize;
    }
};
leftNavigationTree.init = function(transferFlag) {
	...
	leftNavigationTree.node=rootNode;
