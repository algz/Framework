 ...
 */
Ext.ux.maximgb.tg.PagingToolbar = Ext.extend(ExtPagingToolBar,
{
    activeDisplayMsg : '显示选中项子级{0}-{1}条，共{2}条',
    
    activeEmptyMsg:"选中项子级无数据",
    ...
    updateInfo : function()
    {
        ...
        if (this.displayItem) {
            ...
            if(Ext.isEmpty(this.store.getActiveNode())){
	           	 msg = count == 0 ?
	                     this.emptyMsg 
	                         :
	                     String.format(
