...
public class ExcelServiceImpl implements ExcelService {
	 ...
	 */
	@Override
	public ExcelView createExcelView(ModelMap model,HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		Object bean=ApplicationContextFactoryUtil.getBean(model.get("className")+"");
		//依次需要传入 class对象、方法名、参数类型
		Method  mh = ReflectionUtils.findMethod(bean.getClass(), model.get("methodName")+"",new Class[]{Object.class} );  
		HSSFWorkbook wb =(HSSFWorkbook)ReflectionUtils.invokeMethod(mh,  bean,model.get("paramValue"));  
