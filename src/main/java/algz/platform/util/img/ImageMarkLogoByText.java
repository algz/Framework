package algz.platform.util.img;
...
public class ImageMarkLogoByText {
	...
	public static void main(String[] args) {
		...
		String logoText = "[ 测试文字水印 http://www.micmiu.com ]";
		String targerPath = "d:/test/micmiu/img_mark_text.jpg";
		String targerPath2 = "d:/test/micmiu/img_mark_text_rotate.jpg";
